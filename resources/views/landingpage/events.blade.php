...
<link rel="stylesheet" href="{{ asset('lp-css/events_1.css') }}">
@section('content')
                    ...
                    @foreach ( $upcoming_events as $value )
                        <div class="event">
                            ...
                            <div class="d-flex w-100 pt-2">
                                <span class="detail-event align-self-start" style="font-size: 14px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                                    </svg>
                                    DETAIL
                                </span>
                                <a href="{{route('eventsRegis', ['events' => $value['id']])}}" class="register-event ml-auto text-decoration-none text-white" style="font-size: 14px;">
                                    REGISTER
                                ...
                                <div class="container-fluid event-s">
                                    <div class="container position-relative">
                                        <div>
                                            ...
                                            <div class="d-flex w-100 pt-2 flex-column">
                                                ...
                                                <div class="d-flex w-100 justify-content-center">
                                                    <div class="d-flex" style="width:650px;">
